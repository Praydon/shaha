...
const photoSizes = {
  ...
  "other/autumn-cat-window": "(min-width: 760px) 320px, 78vw",
  "other/autumn-cat-blanket": "(min-width: 760px) 320px, 78vw",
...
const archiveGroups = [
  {
    label: "мы",
    photos: [
      ["together/first-kiss", "Первый поцелуй"],
      ["together/cinema-date", "14 февраля"],
      ["together/mirror-selfie", "Зеркальное фото"],
      ["together/warm-hug", "Тёплый кадр"],
      ["together/night-mirror", "Ночное зеркало"],
      ["together/together-smile", "Улыбка вдвоём"],
      ["together/hero", "Тихий совместный кадр"],
      ["together/mountain-date", "Горы и вода"],
      ["together/night-smiles", "Вечерние улыбки"],
      ["together/our-favorite", "Наш любимый кадр"],
      ["together/ending", "Финальный кадр"],
    ],
  },
  {
    label: "Шаха",
    photos: [
      ["shaha/dream-day", "Dream day"],
      ["shaha/flowers-princess", "Цветы"],
      ["shaha/golden-light", "Золотой свет"],
      ["shaha/sunny-girl", "Солнечный день"],
      ["shaha/winter-smile", "Зимняя улыбка"],
      ["shaha/cafe-smile", "Кафе"],
      ["shaha/paris", "Париж"],
      ["shaha/798A90AF-F291-447E-913E-FC6BA8FF3190", "Портрет"],
      ["shaha/086A3D15-E4D0-41A9-8D85-7713696DFD0C", "Кадр"],
      ["shaha/62368EF2-3360-401B-9282-0FD12D33D921", "Кадр"],
      ["shaha/B4699527-AFB2-414E-9AF3-022503E074F6", "Кадр"],
      ["shaha/flowers-evening", "Вечер с цветами"],
      ["shaha/night-girl", "Ночной кадр"],
      ["shaha/IMG_3228", "IMG_3228"],
      ["shaha/D3936633-CBDC-4471-8CFF-6CA52491958A", "Кадр"],
      ["shaha/7227E024-1540-463B-B821-037666EB534B", "Кадр"],
      ["shaha/CCC891CD-6BDC-479E-9F2A-00682239D1FC", "Кадр"],
      ["shaha/8AA993D0-6670-483C-85ED-48C4E4BE3835", "Кадр"],
      ["shaha/elegant", "Elegant"],
      ["shaha/museum-day", "Museum day"],
    ],
  },
  {
    label: "до нас",
    photos: [
      ["childhood/little-princess", "Little princess"],
      ["childhood/little-shaha", "Little Shaha"],
      ["childhood/little-video-call", "Little video call"],
    ],
  },
  {
    label: "артефакты",
    photos: [
      ["other/discord-calls", "Discord calls"],
      ["other/santa-memory", "Secret Santa"],
      ["other/autumn-cat-window", "Осенний кот у окна"],
      ["other/autumn-cat-blanket", "Осенний кот на пледе"],
      ["other/autumn-cats", "Осенний диптих"],
    ],
  },
];
